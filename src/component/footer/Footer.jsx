...
const Footer = () => {
  return (
    <footer>
      <div className="bg-footer md:py-24 md:px-[120px] max-md:px-6 max-md:py-12">
        ...
        <div className="text-center">
          <button
            type="button"
            className="py-3 px-6 inline-flex items-center gap-x-2 text-lg font-medium rounded-full border border-transparent bg-white text-black/85 hover:bg-blue-700 hover:text-white focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
          >
            Request a demo{" "}
            <svg
              width="9"
            ...
            >
              <path
                d="M1.5 1.52637L7.5 7.52637L1.5 13.5264"
                stroke="black"
                strokeOpacity="0.85"
                strokeWidth="2"
              />
        ...
        <hr className="h-[1px] border-t border-white/[0.16] my-20" />

        <div className="flex gap-4 md:justify-between md:pb-24 max-md:pb-10">
          <div className="flex-none min-w-72">
            <svg
              width="94"
              height="25"
              viewBox="0 0 94 25"
        ...
        <div className="flex gap-2 mb-0.5">
          ...
          >
            <path
              d="M16.6992 9.53856C16.6992 5.28965 13.2548 1.84521 9.00585 1.84521C4.75693 1.84521 1.3125 5.28965 1.3125 9.53856C1.3125 13.7875 4.75693 17.2319 9.00585 17.2319C13.2548 17.2319 16.6992 13.7875 16.6992 9.53856Z"
              stroke="white"
              strokeWidth="1.125"
            />
            <path
              d="M12.0171 4.86234C12.0171 3.19603 10.6663 1.84521 9 1.84521C7.33369 1.84521 5.98288 3.19603 5.98288 4.86234V14.2148C5.98288 15.8811 7.33369 17.2319 9 17.2319C10.6663 17.2319 12.0171 15.8811 12.0171 14.2148V4.86234Z"
              stroke="white"
              strokeWidth="1.125"
            />
            <path
              d="M1.64703 9.47949H16.6992"
              stroke="white"
              strokeWidth="1.125"
            />
          </svg>
